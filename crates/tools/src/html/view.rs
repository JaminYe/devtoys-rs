...
impl ReceivesData for HtmlView {
    fn on_data_received(
        &mut self,
        _payload: &str,
        _window: &mut Window,
        ...
        v_flex()
            ...
            .child(
                h_flex()
                    ...
                    .items_center()
                    .flex_wrap()
                    .child(self.conversion_button("html-encode", "编码", Conversion::Encode, cx))
                    .child(self.conversion_button("html-decode", "解码", Conversion::Decode, cx))
                    .child(
                        Button::new("html-copy")
                            .primary()
                            .label("复制")
